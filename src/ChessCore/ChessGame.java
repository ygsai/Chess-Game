...
public abstract class ChessGame {
    ...
    public Player whoseTurn = Player.WHITE;
    public Stack<ChessBoard> boardStack = new Stack<>();
    ...
    private void notifyObservers() {
        for (int i = 0; i < observers.size(); i++) {
            observers.get(i).onChessGameStateChanged();
        }
    }
    ...
    private final Stack<Piece> capturedPiecesStack = new Stack<>();
    ...
    public boolean makeMove(Move move) {
        ...
        Piece capturedPiece = board.getPieceAtSquare(move.getToSquare());
        ...
        if (fromPiece instanceof Pawn
            ...
            capturedPiece = board.getPieceAtSquare(lastMove.getToSquare());
...
//                switch (promotion) {
//                    case Queen:
//                        fromPiece = pieces.createPiece("QUEEN", playerPromoting);
//                        break;
//                    case Rook:
//                        fromPiece = pieces.createPiece("ROOK", playerPromoting);
//                        break;
//                    case Knight:
//                        fromPiece = pieces.createPiece("KNIGHT", playerPromoting);
//                        break;
//                    case Bishop:
//                        fromPiece = pieces.createPiece("BISHOP", playerPromoting);
//                        break;
//                    case None:
